    ...
    <section className="max-w-[900px] mx-auto w-full px-6 lg:px-10 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="border border-[#EBEBEB] rounded-[20px] overflow-hidden">
            ...
            <a href={`mailto:${EMAIL}`}
              ...
              <div>
                <p className="text-[11px] text-[#BBBBBB] font-medium tracking-[1px] uppercase mb-0.5">
                  Email
                </p>
                ...
                <p className="text-[12.5px] text-[#BBBBBB] mt-0.5">
            ...
            {/* Office */}
            <div className="p-6">
              <p className="text-[11px] text-[#BBBBBB] font-medium tracking-[1px] uppercase mb-1">
                Office
              </p>
              <a href={CO_SITE} target="_blank" rel="noopener noreferrer"
                className="text-[13.5px] font-semibold text-[#0A0A0A]
                  hover:text-[#B31B38] transition-colors block">
                {CO_NAME}
              </a>
              <p className="text-[13px] text-[#999] mt-0.5 leading-snug">{ADDRESS}</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="border border-[#EBEBEB] rounded-[20px] overflow-hidden">
            {LEGAL.map(({ label, sub, href }, i) => (
              <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                className={`group flex items-center justify-between gap-4 p-6
                ...
                <div>
                  ...
                  <p className="text-[12.5px] text-[#BBBBBB] mt-0.5">{sub}</p>
                </div>
          ...
          {/* Company blurb */}
          <div className="mt-4 bg-[#FAFAFA] border border-[#EBEBEB] rounded-[16px] p-5">
