  ...
  return (
    <section
      className="relative flex flex-col items-center justify-center
        px-6 pt-24 pb-20 text-center overflow-hidden"
      style={{
        background:
    ...
    >
      ...
      >
        <div
          className="relative w-[100px] h-[100px] sm:w-[120px] sm:h-[120px]
            rounded-[32px] sm:rounded-[38px] bg-[#B31B38] text-white flex items-center justify-center
      ...
      <h1 className="fade-up-d1 font-tamil font-bold text-[#0A0A0A] leading-none tracking-tight
        text-[52px] sm:text-[72px] lg:text-[88px]">
        இணை.lk
      </h1>

      <p className="fade-up-d2 mt-3 text-[13px] sm:text-[14px] font-semibold
        tracking-[3px] uppercase text-[#B31B38]">
        Sri Lankan Tamil Matrimony
      </p>

      <p className="fade-up-d3 mt-6 max-w-[560px] text-[15px] sm:text-[16px] font-light
      ...
      <div className="fade-up-d4 mt-8 flex items-center gap-3 flex-wrap justify-center">
        <a
          href={SITE}
          className="inline-flex items-center gap-2 bg-[#B31B38] text-white font-semibold
            text-[14px] sm:text-[15px] px-7 py-3.5 rounded-[14px] hover:bg-[#9A1730]
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border border-[#E8E8E8] text-[#0A0A0A]
            font-medium text-[14px] sm:text-[15px] px-7 py-3.5 rounded-[14px]
